...
def run_test(path, max_train_size):
    run_optimization({
        "io_parameters": {
            "results_path": path,
...
run_test("13_max_train_size_inf", float("inf"))
run_test("13_max_train_size_100", 100)
...
results_dict = load_complete_input_results(
    BBO_experiments_dict={"max train inf": "13_max_train_size_inf/", "max train 100": "13_max_train_size_100/"},
