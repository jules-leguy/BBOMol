...
model = GaussianProcessRegressor(1.0*RBF(1.0) + WhiteKernel(), optimizer="fmin_l_bfgs_b", normalize_y=True)
...
alg = BBOAlg(
    ...
    surrogate=surrogate,
    stop_criterion=KObjFunCallsFunctionStopCriterion(200),
    evomol_parameters={
    ...
    results_path="test/test_whitekernel",
